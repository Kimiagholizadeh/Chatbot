...
var SlotScene = cc.Scene.extend({
  ...
  _buildUI: function(){
    ...
    this.ui.betInfoPanel = this._makePanel(480, 250, 1100, 476, ["bet_popup_panel_bg","popup_panel_bg","auto_popup_panel","auto_panel"]);
    ...
    this.ui.autoPanelInfo = this._makePanel(480, 250, 1100, 668, ["popup_panel_bg","auto_popup_panel","bet_popup_panel","auto_panel"]);
